    ...
    <div className="min-h-screen bg-gradient-to-b from-[#121016] via-[#0c0c12] to-[#0a0a10] text-white">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 py-16 space-y-8">
        ...
        {latestDrops.length > 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { title: 'Underground Sessions', date: 'Coming Soon', venue: 'TBA', desc: 'Late-night underground techno and house sessions with resident DJs.' },
              { title: 'Warehouse Rave', date: 'Coming Soon', venue: 'TBA', desc: 'A raw, immersive warehouse experience featuring the best electronic acts.' },
              { title: 'Rooftop Sunset Set', date: 'Coming Soon', venue: 'TBA', desc: 'Open-air rooftop vibes as the sun goes down. Melodic and deep.' },
            ].map((placeholder) => (
              <div
                key={placeholder.title}
                className="rounded-xl border border-orange-600/20 bg-gradient-to-br from-zinc-900/50 to-black/70 overflow-hidden shadow-lg shadow-orange-900/10"
              >
                <div className="flex flex-col">
                  <div className="relative overflow-hidden aspect-[16/9] min-h-[220px] bg-gradient-to-br from-orange-950/30 via-zinc-900 to-black flex items-center justify-center">
                    <p className="text-orange-400/40 text-sm font-medium">Event Image</p>
                  </div>
                  <div className="p-4 space-y-2">
                    <p className="text-[0.65rem] font-semibold uppercase tracking-wide text-orange-400/50">{placeholder.date}</p>
                    <h3 className="text-base font-bold text-white/80">{placeholder.title}</h3>
                    <p className="text-gray-500 text-xs leading-relaxed">{placeholder.desc}</p>
                    <div className="flex items-center justify-between p-3 rounded-lg bg-gradient-to-br from-orange-950/20 to-black/40 border border-orange-600/10 mt-3">
                      <div>
                        <p className="text-[0.6rem] font-medium text-orange-400/40">Venue</p>
                        <p className="text-xs text-white/50 font-semibold mt-0.5">{placeholder.venue}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-[0.6rem] font-medium text-orange-400/40">Price</p>
                        <p className="text-lg font-bold text-orange-400/40 mt-0.5">TBA</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        {featuredDjs.length > 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              >
                <div className="flex flex-col h-[320px]">
                  <div className="relative overflow-hidden h-40 bg-gradient-to-br from-orange-950/30 via-zinc-900 to-black flex items-center justify-center">
                    <div className="h-16 w-16 rounded-full bg-gradient-to-br from-orange-600/20 to-orange-900/20 border border-orange-600/20 flex items-center justify-center">
                      <span className="text-orange-400/40 text-2xl font-bold">{placeholder.name[0]}</span>
                    </div>
                  </div>
                  <div className="p-4 flex flex-col justify-between flex-1">
                    <div className="space-y-2">
                      ...
                      <span className="inline-block px-2 py-0.5 rounded-full text-[0.6rem] font-medium bg-gradient-to-r from-orange-950/30 to-[#5D1725]/30 text-orange-300/50 border border-orange-600/15">
                        {placeholder.genre}
                      </span>
                    </div>
                  </div>
